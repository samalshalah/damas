  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <PageHero
        ...
        image="/images/damas/tire-shop-hero.webp"
        imageAlt="Mechanic helping with tires in a tire shop"
        stats={[
            ...
            >
              ...
              >
                <div className="h-44 overflow-hidden">
                  <img src="/images/damas/tire-shop-hero.webp" alt="Tires" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300 opacity-60" />
                </div>
                <div className="p-6 flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h2 className="text-lg font-bold font-display mb-1.5">Tires</h2>
                    <p className="text-primary-foreground/80 text-sm leading-relaxed mb-3">Ask Damas Auto Repair about tire availability, installation, rotation, and balancing.</p>
      ...
      <section className="py-16 bg-white dark:bg-zinc-900 border-t">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold font-display tracking-tight mb-4">Tire Care at Damas Auto Repair</h2>
          <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">
            Keep your vehicle riding smoothly with tire rotation, balancing, and tire-related inspection support from our Chantilly shop.
          </p>
