...
export function VariantD() {
  return (
    <div className="min-h-screen bg-[#0f0f0f]">
      <div className="min-h-[640px] relative flex items-stretch overflow-hidden">
        ...
        <div className="absolute left-[48%] top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[#C41E3A] to-transparent opacity-50" />

        {/* Content */}
        <div className="relative z-10 w-[52%] flex flex-col justify-center px-16 py-20">
          {/* Top row */}
          ...
          <h1 className="text-[4.5rem] font-black text-white leading-[0.95] tracking-tight mb-6">
            BRAKE<br />
            <span className="text-[#C41E3A]">REPAIR</span><br />
            <span className="text-zinc-600 text-4xl">& SERVICE</span>
          </h1>
          ...
          <p className="text-zinc-400 text-base leading-relaxed mb-10 max-w-sm">
            ...
            Springfield and Centreville, VA. Same-day service. Since 2004.
          </p>
          ...
          <div className="flex flex-col gap-3 max-w-xs">
            <button className="w-full bg-[#C41E3A] text-white font-bold py-4 px-6 rounded-xl text-sm flex items-center justify-between group hover:bg-[#a01830] transition-colors">
            ...
            <button className="w-full bg-white/5 border border-white/10 text-white font-semibold py-4 px-6 rounded-xl text-sm flex items-center justify-between hover:bg-white/10 transition-colors">
              <span className="flex items-center gap-2">
